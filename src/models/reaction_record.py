...
from sqlalchemy import Integer, String, DateTime, BigInteger, Text
...
class ReactionRecord(BaseModel):
    ...
    @classmethod
    def create(cls, group_id: Optional[str], user_id: str, message_id: int, arxiv_id: str, emoji: str) -> 'ReactionRecord':
        """
        创建新的反应记录
    ...
    @classmethod
    def get_by_context(cls, group_id: Optional[str], user_id: str, message_id: int) -> Optional['ReactionRecord']:
        """
    ...
    @classmethod
    def get_by_message_and_user_and_emoji(cls, message_id: int, user_id: str, emoji: str) -> Optional['ReactionRecord']:
        """
